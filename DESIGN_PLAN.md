...
- `.github/workflows/release.yml` builds Linux (tar.gz with .desktop + icon), Windows (zip) and macOS (dmg) on a `v*` tag and attaches them to a GitHub release. No mobile releases yet.
